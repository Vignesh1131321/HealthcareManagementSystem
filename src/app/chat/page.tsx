...
if (userMessage.text.toLowerCase().startsWith("hi") ||userMessage.text.toLowerCase().startsWith("hello") ) {
  modifiedInput = userMessage.text; // No modification for messages starting with "hi"
} else {
  modifiedInput = `${userMessage.text} Always answer very briefly in 2 or 3 lines.`;
}
